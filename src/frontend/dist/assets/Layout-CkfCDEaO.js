import { c as createLucideIcon, u as useCategories, B as Button } from "./useBackend-VTWkwZMk.js";
import { r as reactExports, j as jsxRuntimeExports, L as Link, u as useNavigate } from "./index-D6eHYULl.js";
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              ...
              className: [
                "whitespace-nowrap px-3 py-1.5 rounded-sm text-sm transition-smooth focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
                !activeTypeId ? "bg-primary text-primary-foreground font-medium" : "text-muted-foreground hover:text-foreground hover:bg-muted"
              ].join(" "),
              "data-ocid": "category-nav-all",
              children: "全部"
            }
          ),
          isLoading ? Array.from({ length: 5 }, (_, i) => `cat-skel-${i}`).map((id2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "h-7 w-16 rounded-sm bg-muted animate-pulse"
            },
            id2
          )) : topLevel.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            CategoryItem,
            {
              category: cat,
...
function Navbar({ activeTypeId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      "data-ocid": "navbar",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-4 sm:px-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Vod" })
              ]
            }
          ),
          !isMobile && /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSearch, className: "flex-1 max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "后台" })
              ]
            }
          ),
        ...
        !isMobile && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-2 border-t border-border/30 pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryNav, { activeTypeId }) }),
        isMobile && mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/30 py-3 space-y-3 animate-slide-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSearch, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground pointer-events-none" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryNav, { activeTypeId }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/momoazz",
...
function Layout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background text-foreground", children: [
    showNavbar && /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { activeTypeId }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        "data-ocid": "footer",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-sm text-foreground/70", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Momo" }),
              "Vod"
            ] }),
...
export {
  ...
  Star as a,
  usePresence as b,
  useIsomorphicLayoutEffect as c,
  LayoutGroupContext as d,
  isHTMLElement as i,
  motion as m,
  useConstant as u
};
